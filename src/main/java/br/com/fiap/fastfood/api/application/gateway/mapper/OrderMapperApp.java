...
import br.com.fiap.fastfood.api.entities.order.state.impl.OrderAwaitingPaymentState;
import br.com.fiap.fastfood.api.entities.order.state.impl.OrderCancelledState;
import br.com.fiap.fastfood.api.entities.order.state.impl.OrderFinishedState;
import br.com.fiap.fastfood.api.entities.order.state.impl.OrderInCreationState;
import br.com.fiap.fastfood.api.entities.order.state.impl.OrderInPreparationState;
import br.com.fiap.fastfood.api.entities.order.state.impl.OrderOperationNotAllowedException;
import br.com.fiap.fastfood.api.entities.order.state.impl.OrderReadyState;
import br.com.fiap.fastfood.api.entities.order.state.impl.OrderReceivedState;

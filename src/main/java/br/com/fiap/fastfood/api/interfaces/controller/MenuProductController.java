package br.com.fiap.fastfood.api.interfaces.controller;
...
public class MenuProductController {
  ...
  public MenuProductController(
    ...
    this.IMenuProductService = new MenuProductServiceImpl(menuProductRepositoryAdapter);
  }

  @GetMapping
  public ResponseEntity<MenuProductResponseDTO> getAll() {
    List<MenuProductDTO> allProducts = IMenuProductService.getAll();
  ...
  public ResponseEntity<MenuProductDTO> getById(@PathVariable Long id) {
    MenuProductDTO menuProductDTO = IMenuProductService.getById(id);
  ...
  public ResponseEntity<Void> create(@Valid @RequestBody MenuProductDTO menuProductDTO) {
    IMenuProductService.register(menuProductDTO);
  ...
  public ResponseEntity<Void> update(@PathVariable Long id,
    ...
    IMenuProductService.update(id, menuProductDTO);
    return ResponseEntity.status(HttpStatus.OK).build();
  }

  @DeleteMapping("/{id}")
  public ResponseEntity<Void> delete(@PathVariable Long id) {
    IMenuProductService.remove(id);
    return ResponseEntity.status(HttpStatus.OK).build();
  }
